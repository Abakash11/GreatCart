# Generated by Django 5.1.6 on 2025-04-07 16:37
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('store', '0003_alter_product_colors_alter_product_sizes'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('adress_2', models.CharField(blank=True, max_length=200)),
                ('pin', models.CharField(max_length=100)),
                ('oredr_note', models.CharField(blank=True, max_length=500)),
                ('order_value', models.FloatField()),
                ('tax', models.FloatField()),
                ('status', models.CharField(choices=[('New', 'New'), ('Accepted', 'Accpted'), ('Complited', 'Complited'), ('Canceled', 'Canceled')], default='new', max_length=10)),
